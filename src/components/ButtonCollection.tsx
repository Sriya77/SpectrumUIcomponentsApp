  ...
  const buttons = [
    {
      ...
      code: `<Button classname = "bg-white">Primary</Button>`,
    },
    {
    ...
    },
    {
      ...
      code: `<Button disabled><Loader className="mr-2 h-4 w-4 animate-spin" />Loading</Button>`,
    },
    {
      name: "submitButton",
...
export function SecondaryButton() {
  return <Button variant="secondary" className="">Secondary</Button>;
}
